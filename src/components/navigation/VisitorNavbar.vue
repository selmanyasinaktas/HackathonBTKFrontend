<template>
  <nav class="light:bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="flex items-center md:order-2 space-x-4 md:space-x-2 rtl:space-x-reverse relative w-15">
        ...
        <router-link
          to="/auth/login"
          class="hidden md:inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-blue-600 border border-blue-600 rounded-lg cursor-pointer hover:bg-blue-600 hover:text-white dark:text-blue-400 dark:border-blue-400 dark:hover:bg-blue-400 dark:hover:text-white"
        >
          Giriş Yap
        </router-link>
       </div>
      ...
      <div
        ...
        class="items-center justify-between md:ml-16 lg:ml-48 w-full md:flex md:w-auto md:order-1"
        id="navbar-language"
      >
        <ul
        ...
        >
          <li>
            <router-link :to="'/'" :class="getLinkClass('/home')">Anasayfa</router-link>
          </li>
          <li>
            <router-link :to="'/about'" :class="getLinkClass('/about')">Hakkımızda</router-link>
          </li>
          <!-- <li>
            <router-link :to="'/contact'" :class="getLinkClass('/contact')">İletişim</router-link>
          </li> -->
        </ul>
        <div class="flex float-end mt-3 md:hidden">
          <router-link
          to="/register"
          class="items-center font-medium justify-center px-4 py-2 text-sm text-gray-900 dark:text-white rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"
        >
          Kayıt Ol
        </router-link>
        <router-link
          to="/login"
          class="items-center font-medium justify-center px-4 py-2 text-sm text-blue-600 border border-blue-600 rounded-lg cursor-pointer hover:bg-blue-600 hover:text-white dark:text-blue-400 dark:border-blue-400 dark:hover:bg-blue-400 dark:hover:text-white"
        >
          Giriş Yap
        </router-link>
        </div>
