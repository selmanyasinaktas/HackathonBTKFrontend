...
const updateUserInfo = async () => {
  ...
  try {
    ...
    const response = await fetch("/api/v1/account/update/user-info", {
      method: "POST",
      headers: {
...
const updateEmail = async () => {
  ...
  try {
    ...
    const response = await fetch("/api/v1/account/update/mail", {
      method: "POST",
      headers: {
        "Authorization": `Bearer ${token}`,
        "Content-Type": "application/json",
...
const updatePassword = async () => {
  ...
  try {
    ...
    const response = await fetch("/api/v1/account/update/password", {
      method: "POST",
      headers: {
        "Authorization": `Bearer ${token}`,
        "Content-Type": "application/json",
